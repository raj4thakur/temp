...
const deliverables = [
  ...
  "CMS architecture and deployment",
  "API-driven web ecosystems",
];

const focusAreas = [
  { icon: "fa-laptop", color: "#13AAB3", bg: "rgba(19,170,179,0.1)", title: "Custom Web Applications", desc: "Designing powerful, scalable web applications that serve as the digital face of your business operations." },
  { icon: "fa-mobile-alt", color: "#2980B9", bg: "rgba(41,128,185,0.1)", title: "Responsive Digital Experiences", desc: "Creating interfaces that seamlessly adapt across all devices to provide optimal user engagement." },
  { icon: "fa-shopping-cart", color: "#E67E22", bg: "rgba(230,126,34,0.1)", title: "E-Commerce Integration", desc: "Building unified commerce platforms that connect inventory, sales, and customer management." },
  { icon: "fa-paint-brush", color: "#27AE60", bg: "rgba(39,174,96,0.1)", title: "Premium UX/UI Design", desc: "Delivering cinematic, highly interactive designs that leave a lasting impression and drive conversion." },
];

const outcomes = [
  "Elevated brand presence online",
...
export default function SolutionsDigitalSolutions() {
  return (
    <main style={{ background: "#F4F9FB", minHeight: "100vh" }}>
      <section className="hero case-study-hero" style={{ position: "relative", padding: "110px 0 100px", backgroundImage: "url(/images/digital_solutions_hero.png)", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, color: "white" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.8rem, 6vw, 4.5rem)", marginBottom: "28px", maxWidth: "860px", lineHeight: "1.1", fontWeight: "700" }}>Website &amp; Digital Solutions</h1>
          <div style={{ display: "inline-block", padding: "10px 28px", background: "rgba(19,170,179,0.15)", backdropFilter: "blur(10px)", color: "white", borderRadius: "50px", fontSize: "1rem", fontWeight: "600", border: "1px solid rgba(19,170,179,0.4)" }}>Premium Digital Experiences &amp; Web Architectures</div>
        </div>
      </section>
      ...
      <div className="container" style={{ position: "relative", zIndex: 10, marginTop: "-80px", paddingBottom: "60px" }}>
        ...
        <div className="eco-card" style={{ background: "white", padding: "56px", borderRadius: "24px", boxShadow: "0 20px 60px rgba(0,0,0,0.06)", marginBottom: "30px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: "60px", alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "2rem", marginBottom: "20px", color: "var(--color-primary)", fontWeight: "700" }}>Digital Presence Redefined</h2>
              <p style={{ color: "#395568", lineHeight: "1.9", fontSize: "1.1rem" }}>
                In a digital-first economy, your website is the most critical touchpoint for your brand. Aurbient Technologies designs and engineers high-performance web applications, robust e-commerce platforms, and immersive digital solutions that captivate users and drive measurable business growth.
              </p>
            </div>
            <div style={{ padding: "44px", background: "linear-gradient(135deg, var(--color-primary) 0%, #0a141b 100%)", color: "white", borderRadius: "20px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontStyle: "italic", lineHeight: "1.8", fontSize: "1.15rem", margin: 0, position: "relative", zIndex: 2 }}>
                "A truly effective digital solution bridges the gap between aesthetic brilliance and underlying technical performance, converting visitors into long-term partners."
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: "48px", background: "white", padding: "60px", borderRadius: "24px", border: "1.5px solid #E2EBE7", boxShadow: "0 20px 40px rgba(0,0,0,0.03)" }}>
          <div style={{ textAlign: "center", marginBottom: "30px" }}>
            <span style={{ fontSize: "0.85rem", color: "var(--color-accent)", textTransform: "uppercase", fontWeight: "700", letterSpacing: "2px", display: "block", marginBottom: "12px" }}>Development Methodology</span>
            <h3 style={{ fontSize: "2.2rem", fontWeight: "700", color: "var(--color-primary)" }}>End-to-End Digital Engineering</h3>
            <p style={{ color: "#58798C", fontSize: "1.1rem", maxWidth: "600px", margin: "16px auto 0" }}>Our systematic approach to delivering high-performance digital experiences.</p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px", position: "relative" }}>
            ...
            {[
              { step: "01", title: "Discovery & Strategy", desc: "Understanding your brand, target audience, and business objectives.", icon: "fa-search" },
              { step: "02", title: "UX/UI Design", desc: "Crafting wireframes and interactive prototypes for seamless navigation.", icon: "fa-pencil-ruler" },
              { step: "03", title: "Full-Stack Development", desc: "Building secure, scalable front-end and back-end architectures.", icon: "fa-code" },
              { step: "04", title: "Launch & Optimization", desc: "Deploying the solution and continuously monitoring performance.", icon: "fa-rocket" }
            ].map((node, idx) => (
        ...
        <div style={{ marginBottom: "48px" }}>
          <div style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto 50px" }}>
            ...
            <h2 style={{ fontSize: "2.2rem", fontWeight: "700", color: "var(--color-primary)", marginBottom: "16px" }}>Digital Focus Areas</h2>
            <p style={{ color: "#58798C", fontSize: "1.05rem" }}>Key disciplines we leverage to build immersive and robust web architectures.</p>
          </div>
        ...
        <section style={{ padding: "72px 0", background: "linear-gradient(135deg, var(--color-primary) 0%, #0a141b 100%)", color: "white", textAlign: "center", borderRadius: "24px", overflow: "hidden" }}>
          <div style={{ maxWidth: "760px", margin: "0 auto", padding: "0 40px" }}>
            <h2 style={{ fontSize: "2.4rem", fontWeight: "700", marginBottom: "20px" }}>Ready to Transform Your Digital Presence?</h2>
            <p style={{ fontSize: "1.15rem", lineHeight: "1.8", color: "rgba(255,255,255,0.7)", marginBottom: "40px" }}>Let's build a premium, intelligent web solution that elevates your brand and engages your users.</p>
            <Link to="/contact" className="btn-premium" style={{ background: "white", color: "var(--color-primary)", padding: "16px 40px", borderRadius: "50px", fontWeight: "700", display: "inline-block", textDecoration: "none" }}>Start Your Project →</Link>
          </div>
        </section>
      </div>
    </main>
