...
const focusAreas = [
  { icon: "fa-globe", color: "#13AAB3", bg: "rgba(19,170,179,0.1)", title: "Enterprise Digital Presence", desc: "Designing professional digital environments capable of supporting business visibility and credibility." },
  ...
  { icon: "fa-expand-arrows-alt", color: "#E67E22", bg: "rgba(230,126,34,0.1)", title: "Scalable Web Platforms", desc: "Developing scalable web architectures designed for long-term operational growth." },
  { icon: "fa-link", color: "#27AE60", bg: "rgba(39,174,96,0.1)", title: "Integrated Business Ecosystems", desc: "Building connected digital systems that support business workflows and enterprise communication." },
];
...
export default function SolutionsSystemIntegration() {
  return (
    <main style={{ background: "#F4F9FB", minHeight: "100vh" }}>
      <section className="hero case-study-hero" style={{ position: "relative", padding: "180px 0 160px", backgroundImage: "url(https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1600&q=80)", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, color: "white" }}>
          ...
          <span style={{ fontSize: "0.9rem", color: "var(--color-accent)", textTransform: "uppercase", fontWeight: "700", letterSpacing: "3px", display: "block", marginBottom: "20px" }}>Solutions Ecosystem 06</span>
          ...
          <div style={{ display: "inline-block", padding: "10px 28px", background: "rgba(19,170,179,0.15)", backdropFilter: "blur(10px)", color: "white", borderRadius: "50px", fontSize: "1rem", fontWeight: "600", border: "1px solid rgba(19,170,179,0.4)" }}>Digital Presence &amp; Enterprise Communication Systems</div>
        </div>
      </section>
      ...
      <div className="container" style={{ position: "relative", zIndex: 10, marginTop: "-80px", paddingBottom: "100px" }}>
        ...
        <div style={{ marginBottom: "80px" }}>
          <div style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto 50px" }}>
            ...
            <p style={{ color: "#58798C", fontSize: "1.05rem" }}>Digital environments built to support enterprise communication, business visibility, and scalable online operations.</p>
          </div>
        ...
        <div className="eco-card" style={{ background: "white", padding: "56px", borderRadius: "24px", marginBottom: "50px", textAlign: "center" }}>
          <span style={{ fontSize: "0.8rem", color: "var(--color-accent)", textTransform: "uppercase", fontWeight: "700", letterSpacing: "2px", marginBottom: "16px", display: "block" }}>Final Positioning Statement</span>
          <p style={{ fontSize: "1.2rem", lineHeight: "1.9", color: "#395568", maxWidth: "800px", margin: "0 auto", fontStyle: "italic" }}>
        ...
        <section style={{ padding: "72px 0", background: "linear-gradient(135deg, var(--color-primary) 0%, #0a141b 100%)", color: "white", textAlign: "center", borderRadius: "24px" }}>
          <div style={{ maxWidth: "760px", margin: "0 auto", padding: "0 40px" }}>
            <h2 style={{ fontSize: "2.4rem", fontWeight: "700", marginBottom: "20px" }}>Elevate Your Digital Business Presence</h2>
            <p style={{ fontSize: "1.15rem", lineHeight: "1.8", color: "rgba(255,255,255,0.7)", marginBottom: "40px" }}>Build an enterprise digital ecosystem that functions as a connected operational communication layer for your business.</p>
