...
const deliverables = [
  ...
  "Custom CRM environments",
  "Integrated operational tools",
];

const focusAreas = [
  { icon: "fa-boxes", color: "#13AAB3", bg: "rgba(19, 170, 179,0.1)", title: "Inventory Management", desc: "Track stock levels, reorders, and movement with absolute precision." },
  { icon: "fa-users", color: "#2980B9", bg: "rgba(41,128,185,0.1)", title: "Custom CRMs", desc: "Manage client relationships using a system built exactly for your sales process." },
  { icon: "fa-truck-loading", color: "#E67E22", bg: "rgba(230,126,34,0.1)", title: "Supply Chain & Logistics", desc: "Connect your suppliers, warehouses, and delivery channels in one place." },
  { icon: "fa-building", color: "#27AE60", bg: "rgba(39,174,96,0.1)", title: "Enterprise Resource Planning", desc: "Unify HR, accounting, operations, and sales under a single digital roof." },
];

const outcomes = [
  "Unified business operations",
  "Elimination of disjointed software",
  "Perfectly tailored workflows",
    ...
    <main style={{ background: "#F4F9FB", minHeight: "100vh" }}>
      <section className="hero case-study-hero" style={{ position: "relative", padding: "110px 0 100px", backgroundImage: "url(/images/business_systems_mockup.png)", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, color: "white" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.8rem, 6vw, 4.5rem)", marginBottom: "28px", maxWidth: "860px", lineHeight: "1.1", fontWeight: "700" }}>Business Management Systems</h1>
          <div style={{ display: "inline-block", padding: "10px 28px", background: "rgba(19, 170, 179,0.15)", backdropFilter: "blur(10px)", color: "white", borderRadius: "50px", fontSize: "1rem", fontWeight: "600", border: "1px solid rgba(19, 170, 179,0.4)" }}>Custom ERPs &amp; Operational Platforms</div>
        </div>
      </section>
      ...
      <div className="container" style={{ position: "relative", zIndex: 10, marginTop: "-80px", paddingBottom: "60px" }}>
        ...
        <div className="eco-card" style={{ background: "white", padding: "56px", borderRadius: "24px", boxShadow: "0 20px 60px rgba(0,0,0,0.06)", marginBottom: "30px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: "60px", alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "2rem", marginBottom: "20px", color: "var(--color-primary)", fontWeight: "700" }}>Software Built For How You Work</h2>
              <p style={{ color: "#395568", lineHeight: "1.9", fontSize: "1.1rem" }}>
                Off-the-shelf software rarely fits your unique business processes perfectly. You end up bending your business to fit the software. We build custom ERPs, inventory management systems, and internal platforms designed exactly around how you operate. Centralize your entire business into one unified, scalable system.
              </p>
            </div>
            <div style={{ padding: "44px", background: "linear-gradient(135deg, var(--color-primary) 0%, #0a141b 100%)", color: "white", borderRadius: "20px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ fontStyle: "italic", lineHeight: "1.8", fontSize: "1.15rem", margin: 0, position: "relative", zIndex: 2 }}>
                "Your software should empower your operations, not restrict them. Custom systems ensure the technology works for you."
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: "48px", background: "white", padding: "60px", borderRadius: "24px", border: "1.5px solid #E2EBE7", boxShadow: "0 20px 40px rgba(0,0,0,0.03)" }}>
          <div style={{ textAlign: "center", marginBottom: "30px" }}>
            ...
            <h3 style={{ fontSize: "2.2rem", fontWeight: "700", color: "var(--color-primary)" }}>How We Build Systems</h3>
            <p style={{ color: "#58798C", fontSize: "1.1rem", maxWidth: "600px", margin: "16px auto 0" }}>From requirements to a fully deployed platform.</p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px", position: "relative" }}>
            ...
            {[
              { step: "01", title: "Analysis", desc: "Understanding your exact operational needs.", icon: "fa-search" },
              { step: "02", title: "Architecture", desc: "Planning the database and system structure.", icon: "fa-sitemap" },
              { step: "03", title: "Development", desc: "Building the custom platform from the ground up.", icon: "fa-code" },
              { step: "04", title: "Deployment", desc: "Launching the system and training your team.", icon: "fa-rocket" }
            ].map((node, idx) => (
        ...
        <div style={{ marginBottom: "48px" }}>
          <div style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto 50px" }}>
            ...
            <h2 style={{ fontSize: "2.2rem", fontWeight: "700", color: "var(--color-primary)", marginBottom: "16px" }}>Platform Capabilities</h2>
            <p style={{ color: "#58798C", fontSize: "1.05rem" }}>Core functionalities we integrate into custom systems.</p>
          </div>
        ...
        <section style={{ padding: "72px 0", background: "linear-gradient(135deg, var(--color-primary) 0%, #0a141b 100%)", color: "white", textAlign: "center", borderRadius: "24px", overflow: "hidden" }}>
          <div style={{ maxWidth: "760px", margin: "0 auto", padding: "0 40px" }}>
            <h2 style={{ fontSize: "2.4rem", fontWeight: "700", marginBottom: "20px" }}>Ready for a Custom System?</h2>
            <p style={{ fontSize: "1.15rem", lineHeight: "1.8", color: "rgba(255,255,255,0.7)", marginBottom: "40px" }}>Stop fighting off-the-shelf software. Let's build a platform that fits your business.</p>
